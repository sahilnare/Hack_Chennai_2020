...
class Rakshak extends Component {
    ...
    return (
      <div>
        ...
        <Row justify="center" style={{marginTop: '50px'}}>
          <Col span={22}>
            <Text h2 style={{fontSize: '30px'}}>Dashboard</Text>
          </Col>
        </Row>
              ...
              <Tabs.Item label="Images Table" value="5">
                <div style={{marginTop: '30px'}}>
                  <Table data={imagesData}>
                    <Table.Column prop="imgurl" width={600}><Text style={{fontSize: '22px'}} b>Image Link</Text></Table.Column>
                    <Table.Column prop="username"><Text style={{fontSize: '22px'}} b>Username</Text></Table.Column>
                    <Table.Column prop="links" width={700}><Text style={{fontSize: '22px'}} b>Reverse Image Search</Text></Table.Column>
                  </Table>
                </div>
              </Tabs.Item>
            </Tabs>
